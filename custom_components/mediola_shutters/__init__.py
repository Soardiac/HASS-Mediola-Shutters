...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    # Register services (only on first entry; handlers resolve coordinator dynamically)
